import { Search, PlusCircle, List, Settings, LogOut, ClipboardCheck, Building2, Shield, Lock, FileSpreadsheet } from 'lucide-react';
import type { UserRole } from '../types/patrimonio';

interface HeaderProps {
  currentScreen: 'home' | 'new' | 'scan' | 'list' | 'config' | 'conferencia' | 'setores' | 'excel';
  onNavigate: (screen: 'home' | 'new' | 'scan' | 'list' | 'config' | 'conferencia' | 'setores' | 'excel') => void;
          ...
          <button
            ...
            className={`px-3.5 py-1.5 rounded-xl text-xs font-bold flex items-center gap-1.5 transition-all cursor-pointer whitespace-nowrap ${
              currentScreen === 'excel'
                ...
                : 'text-neutral-300 hover:text-emerald-300 hover:bg-neutral-800/50'
            }`}
          >
            <FileSpreadsheet className="w-3.5 h-3.5 text-emerald-400" />
            <span>Controle Excel</span>
          </button>
